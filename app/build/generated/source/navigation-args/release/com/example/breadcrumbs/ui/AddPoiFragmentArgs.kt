...
public data class AddPoiFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): AddPoiFragmentArgs {
      bundle.setClassLoader(AddPoiFragmentArgs::class.java.classLoader)
      val __tripId : String?
      ...
      return AddPoiFragmentArgs(__tripId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): AddPoiFragmentArgs {
      val __tripId : String?
